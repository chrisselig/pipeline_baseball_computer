...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Package to automatically retrieve updated data from Baseball Computer",
    Description = "Package retrieves data on a monthly basis from https://baseball.computer/ . Data than is cleaned and transformed and uploaded to a Motherduck database.",
    `Authors@R` = c(
      person("Chris", "Selig", email = "chris.selig@bidamia.ca", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Chris Selig")
```
...
# Code of Conduct
usethis::use_code_of_conduct("chris.selig@bidamia.ca")
# NEWS
usethis::use_news_md()
```
